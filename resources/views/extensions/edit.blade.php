...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <h1 class="text-2xl font-bold text-gray-900">Edit Extension</h1>
            ...
            <form method="POST" action="{{ route('extensions.update', $extension) }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="extension_number" name="extension_number" value="{{ old('extension_number', $extension->extension_number) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" id="display_name" name="display_name" value="{{ old('display_name', $extension->display_name) }}" required
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        @error('display_name')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="password" id="password" name="password" value="{{ old('password', $extension->password) }}" required
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        @error('password')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email', $extension->email) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        @error('email')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select id="device_type" name="device_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            <option value="sip" {{ old('device_type', $extension->device_type) === 'sip' ? 'selected' : '' }}>SIP</option>
                            <option value="pjsip" {{ old('device_type', $extension->device_type) === 'pjsip' ? 'selected' : '' }}>PJSIP</option>
                        </select>
                        @error('device_type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="context" name="context" value="{{ old('context', $extension->context) }}" required
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        @error('context')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="md:col-span-2">
                        <div class="flex items-center">
                            <input type="checkbox" id="call_forwarding_enabled" name="call_forwarding_enabled" value="1"
                                   {{ old('call_forwarding_enabled', $extension->call_forwarding_enabled) ? 'checked' : '' }}
                                   class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                            <label for="call_forwarding_enabled" class="ml-2 block text-sm text-gray-900">
                                Enable Call Forwarding
                            </label>
                        </div>
                        <div class="mt-2" id="call_forwarding_number_div" style="display: {{ old('call_forwarding_enabled', $extension->call_forwarding_enabled) ? 'block' : 'none' }};">
                            <label for="call_forwarding_number" class="block text-sm font-medium text-gray-700">Forwarding Number</label>
                            <input type="text" id="call_forwarding_number" name="call_forwarding_number" value="{{ old('call_forwarding_number', $extension->call_forwarding_number) }}"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center">
                            <input type="checkbox" id="dnd_enabled" name="dnd_enabled" value="1"
                                   {{ old('dnd_enabled', $extension->dnd_enabled) ? 'checked' : '' }}
                                   class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                    ...
                    <div>
                        ...
                        <div class="mt-2" id="voicemail_box_div" style="display: {{ old('voicemail_enabled', $extension->voicemail_enabled) ? 'block' : 'none' }};">
                            <label for="voicemail_box" class="block text-sm font-medium text-gray-700">Voicemail Box</label>
                            <input type="text" id="voicemail_box" name="voicemail_box" value="{{ old('voicemail_box', $extension->voicemail_box) }}"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                    </div>
                </div>
